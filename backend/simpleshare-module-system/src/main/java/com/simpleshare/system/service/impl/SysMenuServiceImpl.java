...
import com.simpleshare.system.domain.vo.RouterVo;
...
public class SysMenuServiceImpl implements ISysMenuService {
    public static final String PREMISSION_STRING = "perms[\"{}\"]"; 
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            ...
            router.setMeta(new RouterVo.MetaVo(menu.getMenuName(), menu.getIcon(), StringUtils.equals("1", menu.getIsCache()), menu.getPath()));
            ...
            if (!cMenus.isEmpty() && cMenus.size() > 0 && UserConstants.TYPE_DIR.equals(menu.getMenuType())) {
                ...
                children.setMeta(new RouterVo.MetaVo(menu.getMenuName(), menu.getIcon(), StringUtils.equals("1", menu.getIsCache()), menu.getPath()));
    ...
    public List<TreeSelect> buildMenuTreeSelect(List<SysMenu> menus) {
        ...
        return menuTrees.stream().map(menu -> new TreeSelect(menu.getMenuId(), menu.getMenuName(), 
            menu.getChildren() != null ? buildMenuTreeSelect(menu.getChildren()) : null)).collect(Collectors.toList());
    }
